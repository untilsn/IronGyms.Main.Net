    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberDetails", x => x.ProfileId);
                    table.ForeignKey(
                        name: "FK_MemberDetails_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffDetails", x => x.ProfileId);
                    table.ForeignKey(
                        name: "FK_StaffDetails_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerDetails", x => x.ProfileId);
                    table.ForeignKey(
                        name: "FK_TrainerDetails_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_MemberDetails_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberMemberships_MemberDetails_MemberId",
                        column: x => x.MemberId,
                        principalTable: "MemberDetails",
                        principalColumn: "ProfileId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_MemberDetails_MemberId",
                        column: x => x.MemberId,
                        principalTable: "MemberDetails",
                        principalColumn: "ProfileId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckIns_MemberDetails_MemberId",
                        column: x => x.MemberId,
                        principalTable: "MemberDetails",
                        principalColumn: "ProfileId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CheckIns_StaffDetails_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberMembershipId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Payment_ExactlyOneTarget", "(\"MemberMembershipId\" IS NOT NULL AND \"OrderId\" IS NULL) OR (\"MemberMembershipId\" IS NULL AND \"OrderId\" IS NOT NULL)");
                    table.ForeignKey(
